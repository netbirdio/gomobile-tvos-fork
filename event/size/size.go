...
//
// See the github.com/netbirdio/gomobile-tvos-fork/app package for details on the event model.
package size
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/netbirdio/gomobile-tvos-fork/geom package.
	//
