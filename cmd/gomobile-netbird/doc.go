...
Usage:
	...
	gomobile bind [-target android|ios|iossimulator|tvos|tvossimulator|macos|maccatalyst] [-bootclasspath <path>] [-classpath <path>] [-o output] [build flags] [package]

Bind generates language bindings for the package named by the import
path, and compiles a library for the named target system.

The -target flag takes either android (the default), or one or more
comma-delimited Apple platforms (ios, iossimulator, tvos, tvossimulator, macos, maccatalyst).
...
Usage:
	...
	gomobile build [-target android|ios|iossimulator|tvos|tvossimulator|macos|maccatalyst] [-o output] [-bundleid bundleID] [build flags] [package]
