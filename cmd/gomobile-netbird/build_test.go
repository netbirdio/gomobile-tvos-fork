...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/netbirdio/gomobile-tvos-fork/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/netbirdio/gomobile-tvos-fork", "github.com/netbirdio/gomobile-tvos-fork", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/netbirdio/gomobile-tvos-fork", "github.com/netbirdio/gomobile-tvos-fork", 2},
		{"ffffffff t github.com/example/github.com/netbirdio/gomobile-tvos-fork", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/netbirdio/gomobile-tvos-fork/app", "github.com/netbirdio/gomobile-tvos-fork/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/netbirdio/gomobile-tvos-fork/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
