...
var tests = []struct {
...
}{
	{
		name: "ObjC-Testpkg",
		lang: "objc",
		pkg:  "github.com/netbirdio/gomobile-tvos-fork/bind/testdata/testpkg",
	},
	{
		name: "Java-Testpkg",
		lang: "java",
	...
	},
	{
		name:    "Java-Javapkg",
		lang:    "java",
		pkg:     "github.com/netbirdio/gomobile-tvos-fork/bind/testdata/testpkg/javapkg",
		goos:    "android",
		reverse: true,
	},
	{
	...
	},
	{
		name: "Go-Cgopkg",
		lang: "go,java,objc",
		pkg:  "github.com/netbirdio/gomobile-tvos-fork/bind/testdata/cgopkg",
		goos: "android",
	},
}
...
func testGobind(t *testing.T, exporter packagestest.Exporter) {
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{{
		Name:  "github.com/netbirdio/gomobile-tvos-fork",
...
type Struct struct{
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{
		...
		{
			// gobind requires github.com/netbirdio/gomobile-tvos-fork to generate code for reverse bindings.
			Name:  "github.com/netbirdio/gomobile-tvos-fork",
			Files: packagestest.MustCopyFileTree("../.."),
		},
	})
